...
public class PointImpl implements Point, Comparable<Point> {
    ...
    @Override
    public Point shiftLeft(int delta)    {
        return new PointImpl(x - delta, y);
    }

    @Override
    public Point shiftRight(int delta)    {
        return new PointImpl(x + delta, y);
    }

    @Override
    public Point shiftTop(int delta)    {
        return new PointImpl(x, y + delta);
    }

    @Override
    public Point shiftBottom(int delta)    {
        return new PointImpl(x, y - delta);

...
/**
 * Incapsulates coordinate of Element at the Board. All Board Elements must
 * extends from PointImpl, realized from of this interface.
 */
public interface Point extends Comparable<Point> {
    ...
    /**
     * @param delta
     * @return new BoardPoint object shifted left "delta" points
     */
    Point shiftLeft(int delta);

    /**
     * @param delta
     * @return new BoardPoint object shifted right "delta" points
     */
    Point shiftRight(int delta);

    /**
     * @param delta
     * @return new BoardPoint object shifted top "delta" points
     */
    Point shiftTop(int delta);

    /**
     * @param delta
     * @return new BoardPoint object shifted bottom "delta" points
     **/
    Point shiftBottom(int delta);
